...
CREATE INDEX idx_creators_support_link_id ON creators(support_link_id);
CREATE INDEX idx_transactions_from_user ON transactions(from_user_id);
CREATE INDEX idx_transactions_to_creator ON transactions(to_creator_id);
CREATE INDEX idx_withdrawal_requests_creator ON withdrawal_requests(creator_id);
CREATE INDEX idx_supporters_user_creator ON supporters(user_id, creator_id);
